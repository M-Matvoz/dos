% % AnimateRotatingComplexorRealImag
function fnAnimateRotatingComplexor

N=4;
A=2;phi0=0; 

fig=figure; set(fig,'Position',[250,150,2*350,2*350])
N=length(n);pauseSec=0.1;
